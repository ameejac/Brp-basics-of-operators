...
{
    public class day4_AccessModifiereAndKeyword
    {
            public int no1;
            int no11;
            ...
            internal void InternalMethod()
            {
                ...
                string firstName = "Ameeja", lastName = "Cherukuru", final;
                final = firstName + lastName;
                Console.WriteLine("After Joining String " + final);
            }
    }

    class ChildClass : day4_AccessModifiereAndKeyword //Child Class OR Derived Class  : Inheritance
    {
